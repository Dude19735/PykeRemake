...
BOOST_AUTO_TEST_CASE(TestCameraInit1, *all_tests)
{
    ...
    VK5::Vk_CameraMisc misc {
        ...
        .SteeringType=VK5::Vk_SteeringType::ObjectCentric
    };
...
BOOST_AUTO_TEST_CASE(TestCameraGridLayoutGen, *all_tests)
{
    ...
    grid.add(0,0,p,m)                                          .add(0,1,p,VK5::mRT(m,VK5::Vk_RenderType::Rasterizer_IM))
        .add(1,0,p,mST(m,VK5::Vk_SteeringType::CameraCentric)).add(1,1,p,VK5::mSG(m,2));

    auto layout = grid.layout(800, 640);
}

BOOST_AUTO_TEST_CASE(TestViewerFromLayout, *all_tests)
{
    VK5::Vk_CameraPinhole p {
        .wPos = glm::tvec3<VK5::point_type> {5.0f, 5.0f, 5.0f },
        .wLook = glm::tvec3<VK5::point_type> {0.0f, 0.0f, 0.0f },
...
BOOST_AUTO_TEST_CASE(TestViewerEvents, *new_test)
{
    VK5::Vk_CameraPinhole p {
        .wPos = glm::tvec3<VK5::point_type> {5.0f, 5.0f, 5.0f },
        .wLook = glm::tvec3<VK5::point_type> {0.0f, 0.0f, 0.0f },
    ...
    VK5::Vk_LayoutGrid grid(2,2, 0, 0);
    grid.add(0,0,p,VK5::mSG(m,0))
        .add(0,1,p,VK5::mSG(m,1))
        .add(1,0,p,VK5::mSG(m,0))
        .add(1,1,p,VK5::mSG(m,1));
